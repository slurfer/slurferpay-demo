...
export default function ChangeMoneyAmount({
    amount,
    onClose,
}: IProps) {
    ...
    useEffect(() => {
        if (status === 'init') {
            readNfc(
                (message) => {
                    const msgText = decodeNfcRecord(
                        message.records[0]
                    );
                    if (msgText.indexOf(';') < 0)
                        alert('Malformed card data: ' + msgText); // TODO layout error
                    else {
                        const b =
            ...
            {status === 'init' ? (
                ...
                <>
                    ...
                    >
                        ...
                        <Typography>
                            Current balance scanned, updating...
                        </Typography>
                    </div>
                    <Button
                        style={{ position: 'absolute', bottom: 16 }}
